...
import { individualJob } from '../../APIs/career';
import { setJobList, updateIndividualJob } from '../../actions/career';
import store from '../../store';
import { useSelector } from 'react-redux'

const UpdateJob = ( {setAlert, setJobList, jobListing, updateIndividualJob}) => {//change setJobData
  ...
  const [formData, setFormData] = useState(useSelector((state) => jobListing.find(element => element.id === id)))
  const updateJob = useSelector((state) => jobListing.find(element => element.id === id))
  ...
  // console.log(formData)
  // console.log(index)
  // const index = store.getState().career.jobListing.id.findIndex(id);
  // console.log(store.getState().career.jobListing)
  // console.log(index)
  ...
  // let deadline = application_deadline.slice(0, 10);
              ...
              <form className="default-form">
                ...
                <div className="form-group col-lg-12 col-md-12">
                  ...
                  <div className="form-group col-lg-6 col-md-12">
                    <label>Gender</label>
                    <select className="chosen-select" name="gender" value = {gender} onChange={e => onChangeHandler(e)}>
...
UpdateJob.propTypes = {
    ...
    updateIndividualJob: PropTypes.func.isRequired,
    jobListing: PropTypes.object

}

const mapStateToProps = state => ({
    jobListing: state.career.jobListing
})


export default connect(mapStateToProps,{setAlert, setJobList, updateIndividualJob})(UpdateJob)